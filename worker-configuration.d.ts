/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 718c8f95480888f63dc339014dd85cfe)
...
interface __BaseEnv_Env {
	...
	GOOGLE_CLIENT_ID: "";
	AUTH_EMAIL_FROM: "ValueLoop <no-reply@valueloop.local>";
	SMTP_HOST: "";
	SMTP_PORT: "587";
	SMTP_USERNAME: "";
	SMTP_FROM: "ValueLoop <no-reply@valueloop.local>";
	SMTP_SECURE: "starttls";
	OPENAI_TEXT_MODEL: "gpt-5.2";
	OPENAI_IMAGE_MODEL: "gpt-image-1";
	ORGANIZATION_REALTIME: DurableObjectNamespace<import("./src/worker").OrganizationRealtime>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "OrganizationRealtime";
	}
